...
ax1.bar(x, native_means, yerr=native_std, width=width, label='Library Code',
        edgecolor='black', alpha=0.75, hatch='//', error_kw=dict(lw=1.5, capthick=1.5), capsize=5)

ax1.bar(x, user_app_means, yerr=user_app_std, width=width, bottom=native_means, label='User Code',
        edgecolor='black', alpha=0.75, hatch='*', error_kw=dict(lw=1.5, capthick=1.5), capsize=5)
