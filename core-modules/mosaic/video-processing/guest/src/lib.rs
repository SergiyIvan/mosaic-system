...
pub extern "C" fn run() -> u32 {
    ...
    unsafe { host_write_file(video_path.as_ptr(), video_path.len() as u32, media_buf.as_ptr(), video_size) }; // TODO: reuse host_download_to_file?
    ...
    unsafe { host_write_file(watermark_path.as_ptr(), watermark_path.len() as u32, media_buf.as_ptr(), watermark_size) }; // TODO: reuse host_download_to_file?
