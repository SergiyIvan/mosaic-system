...
pub fn process_markdown_to_html(input: &str) -> Result<HTMLOutput, HighlightError> {
...
pub fn process_markdown_to_html_with_frontmatter(input: &str, extract_frontmatter: bool) -> Result<HTMLOutput, HighlightError> {
    ...
    match String::from_utf8(output) {
        ...
        Err(e) => Err(HighlightError::StringGenerationError(e.to_string())),
    }
}
